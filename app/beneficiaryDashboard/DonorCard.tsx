    ...
    >
      ...
      <CardBody>
        ...
        <Typography className="mb-2">
          ...
          Best Before:{" "}
          {donation.bestBeforeDate || "No best before date specified"}
        </Typography>
        ...
        {isDelivery && (
          <>
            ...
            <Typography className="mb-2">
              ...
              Drop-Off Location:{" "}
              {donation.dropOffLocation || "No drop-off location specified"}
            </Typography>
          </>
        )}
        ...
        {isSelfPickUp && (
          <>
            ...
            <Typography className="mb-2">
              <IoLocation className="inline-block mr-2" />
              Pick-up Location:{" "}
              {donation.pickUpLocation || "No pick-up location specified"}
            </Typography>
          </>
        )}
      </CardBody>
