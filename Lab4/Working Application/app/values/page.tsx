    ...
    <div className="bg-gray-50 min-h-screen p-8">
      ...
      <main className="max-w-7xl mx-auto">
        <section className="bg-white rounded-lg shadow-lg p-12 mb-12">
          ...
          <h1 className="text-4xl font-bold text-center mb-8 text-custom-dark-green">Our Values</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-[#F0F4E4] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 text-custom-dark-green">Sustainability</h2>
            ...
            <div className="p-6 bg-[#F0F4E4] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 text-custom-dark-green">Compassion</h2>
            ...
            <div className="p-6 bg-[#F0F4E4] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 text-custom-dark-green">Community</h2>
        ...
        <section className="bg-[#E7EDCF] p-12 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-center text-custom-dark-green mb-8">How We Live Our Values</h2>
          ...
          <div className="text-center mt-8">
            ...
            <a href="/contact-us" className="inline-block bg-custom-dark-green text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-custom-darker-green">
